...
RIzeR_GaY = {}
GaY = 3500 #JITNE ACCOUNT HONGE UTNA HI RAKHNA HAHAHAHAHA JAYADA MAT KARNA LIKE 200 ACCOUNT HAI TO 200
GaY_ReFrEsH = 2 * 60 * 60
LaSt_GaY = 0
    ...
    if player_info:
        return jsonify({
            ...
            "tokens_used": len(tokens),
             "credit": "MEHEDI X AURA KA VISIT API http://t.me/proxaura"
        }), 200
    else:
